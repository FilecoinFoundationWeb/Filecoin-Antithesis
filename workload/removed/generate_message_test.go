...
func TestBuildAndValidateMessage(t *testing.T) {
	...
	for _, node := range filteredNodes {
		...
		powerTableCid, err := certs.MakePowerTableCID(pt.Entries)
		assert.Always(err == nil, "Generating PowerTable CID", map[string]interface{}{"error": err})
		fmt.Println(powerTableCid)
