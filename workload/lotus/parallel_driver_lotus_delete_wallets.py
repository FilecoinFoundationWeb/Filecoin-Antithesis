...
def delete_wallets(n:int):
    ...
    wallets.delete_wallets(node_type, lotus_rpc_url, lotus_auth_token, wallets_to_delete)
    print(f"Workload [Lotus][delete_wallets.py]: a completed wallet deletion script")
