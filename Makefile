...
help:
	...
	@echo ""
	@echo "Docker Compose:"
	@echo "  make up               Start all default services (drand + lotus + lotus-adversary + miners + forest + workload)"
	@echo ""
	@echo "Note: lotus-adversary image is prebuilt externally and assumed to exist as lotus-adversary:latest"
